...
<x-filament::section icon="heroicon-o-camera">
    ...
    <div class="radio-button">
        ...
        <div class="flex w-full items-center ps-4 border border-gray-200 rounded-sm dark:border-gray-700">
            <input id="bordered-radio-3" type="radio" value="dzuhur" name="tipe-absen" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="bordered-radio-3" class="w-full py-4 ps-2 text-sm font-medium text-gray-900 dark:text-gray-300">Sholat Dzuhur</label>
        </div>
        <div class="flex w-full items-center ps-4 border border-gray-200 rounded-sm dark:border-gray-700">
...
let html5QrcodeScanner = new Html5QrcodeScanner(
  "reader",
  { fps: 10, qrbox: {width: 300, height: 300}, supportedScanTypes: [Html5QrcodeScanType.SCAN_TYPE_CAMERA] },
  /* verbose= */ false);
